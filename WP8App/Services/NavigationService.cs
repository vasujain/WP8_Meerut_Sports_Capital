...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : INavigationService
    {
        private static readonly IDictionary<Type, string> ViewModelRouting = new Dictionary<Type, string>()
        {
            ...
            { typeof(ISpecialPlaces_DetailViewModel), "/View/SpecialPlaces_Detail.xaml" },
            { typeof(Imonuments_DetailViewModel), "/View/monuments_Detail.xaml" },
            { typeof(ITravelToMeerut_InfoViewModel), "/View/TravelToMeerut_Info.xaml" },
            { typeof(IWeather_InfoViewModel), "/View/Weather_Info.xaml" },
            { typeof(IEtymology_InfoViewModel), "/View/Etymology_Info.xaml" },
            { typeof(IMythology_InfoViewModel), "/View/Mythology_Info.xaml" },
            { typeof(IGeography_InfoViewModel), "/View/Geography_Info.xaml" },
            { typeof(IEconomy_InfoViewModel), "/View/Economy_Info.xaml" },
            { typeof(IDemographics_InfoViewModel), "/View/Demographics_Info.xaml" },
            { typeof(IFilmTelevision_InfoViewModel), "/View/FilmTelevision_Info.xaml" },
            { typeof(IEducation_InfoViewModel), "/View/Education_Info.xaml" },
            { typeof(IMedia_InfoViewModel), "/View/Media_Info.xaml" },
            { typeof(IHistory_InfoViewModel), "/View/History_Info.xaml" },
        };
