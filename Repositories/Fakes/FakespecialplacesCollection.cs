...
namespace WPAppStudio.Repositories
{
    ...
    public class FakespecialplacesCollection : IspecialplacesCollection 
    {
		/// <summary>
        ...
        {			
            return new ObservableCollection<specialplacesCollectionSchema> 
			{ 
        ...
        {			
			return Filter<specialplacesCollectionSchema>.FilterCollection(filter, GetData());
        }
	}
}
