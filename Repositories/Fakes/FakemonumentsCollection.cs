...
namespace WPAppStudio.Repositories
{
    ...
    public class FakemonumentsCollection : ImonumentsCollection 
    {
		/// <summary>
        ...
        {			
            return new ObservableCollection<monumentsCollectionSchema> 
			{ 
        ...
        {			
			return Filter<monumentsCollectionSchema>.FilterCollection(filter, GetData());
        }
	}
}
